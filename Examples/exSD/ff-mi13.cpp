...
int main(int argc, char** argv) {
    ...
    fp.Propagators = lst {
        k1*2*p, k2*2*p, 1+2*k1*k2+4*k1*p+4*k2*p
    };
    fp.Exponents = lst{ 1, 1, 1 };
    fp.Prefactor = 1/(pow(4*Pi,2)*z0*(1-z0)*2)*pow(2*Pi, 2*(2*ep-2));
    ...
    cout << "0.00234784218991108970280704568547" << endl;
