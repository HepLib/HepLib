...
int main(int argc, char** argv) {
    ...
    cout << "ep*(-95391.32586069929 +- 2.85273E-5)+(1421.2230337568676412 +- 4.7923E-23)*ep^(-2)+(-9395.604538652857158 +- 3.68114E-11)*ep^(-1)+(35413.16687274491 +- 1.55355E-6)" << endl;
