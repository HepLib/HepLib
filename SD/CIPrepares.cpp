...
namespace HepLib::SD {
    ...
    //============================================================================================================
        ...
        if(hasF) {
            ...
            cmd << cpp << " " << LIB_FLAGS <<  " -rdynamic -fPIC -shared -lHepLib -lquadmath -lmpfr -lgmp " << " -o " << sofn.str() << " " << pid << "/F*.o";
            system(cmd.str().c_str());
    ...
    //============================================================================================================
        ...
        if(res_size>GccLimit) {
            cmd.clear();
            cmd.str("");
            cmd << cpp << " " << LIB_FLAGS <<  " -rdynamic -fPIC -shared -lHepLib -lquadmath -lmpfr -lgmp ";
