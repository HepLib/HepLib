...
namespace HepLib::SD {
    ...
    void SecDec::CIPrepares(const string & key) {
        ...
        auto resf =
        GiNaC_Parallel(ParallelProcess, expResult.size(), 0, [&](int idx)->ex {
    ...
    //============================================================================================================
        ...
        // Prepare FT-lambda
        GiNaC_Parallel(ParallelProcess, ftnvec.size(), 0, [&](int idx)->ex {
            // return nothing
            auto kv = ftnvec[idx];
            ex ft = kv.op(0);
            ex ft_n = kv.op(1);
    ...
    //============================================================================================================
        ...
        // Prepare Integrand
        auto res =
        GiNaC_Parallel(ParallelProcess, res_vec.size(), 0, [&](int idx)->ex {
